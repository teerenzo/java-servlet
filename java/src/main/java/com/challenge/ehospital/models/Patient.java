...
public class Patient extends User {
    ...
    public ResponseEntity<User> register() throws Exception {
        ...
        PatientHandlers.createPatient(this);
        return new ResponseEntity<User>("Patient registered successfully!", PatientHandlers.findPatient(getUsername()));
    }

    @Override
    public ResponseEntity<String> login(String username, String Password) throws AuthenticationException {
        Patient existingUser = PatientHandlers.findPatient(username);
